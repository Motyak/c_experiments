...
int main()
{
    ...
    std::cout<<"value of ptr is then : "<<notSmartPtr<<std::endl;
    if(notSmartPtr)
        std::cout<<"pointed value of ptr is then : "<<notSmartPtr->a<<"\t"<<notSmartPtr->b<<std::endl<<std::endl;
    ...
    std::cout<<"value of ptr is then : "<<smartPtr.getPtr()<<std::endl;
    if(smartPtr.getPtr())
        std::cout<<"pointed value of ptr is then : "<<smartPtr.getPtr()->a<<"\t"<<smartPtr.getPtr()->b<<std::endl;
}
